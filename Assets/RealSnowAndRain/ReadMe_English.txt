...
Click the snow prefab instance and you can choose "Intensity" property from "SnowController.cs" component in inspector.
...
If you choose "Custom", you can set  "RainColliderParticle" property in the inspector by yourself manually. To do so, You can click "RainColliderParticle" child of "RainController" in Hierarchy. 
If you click "RainColliderParticle", you can find "RainGroundSplash" and "RainWaterSplash" in child. And if you click "RainGroundSplash" you can find "renderer" tab in the "ParticleSystem" component in inspector. 
...
If you don't need to colliding effect, uncheck RainParticleCollisionProcess script in "RainColliderParticle" object from inspector. Then particle will not collide with another objects. and They will not make spots on surface of the objects.
...
But SnowController3D has 3 types of SnowFlake. -> You can check it from "SnowColliderParticle" object's ParticleSystem component's TextSheetAnimation element and Renderer element. 
And it rotates in 3D axis -> You can check it from "SnowColliderParticle" object's ParticleSystem component's RotationOverLifetime element. 
...
<More detail explanation about "RainColliderParticle" prefab>
...
You can change this code by modifying code RainController.cs or SnowController.cs. See following code.
